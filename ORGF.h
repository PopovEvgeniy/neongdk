...
enum ORGF_SPRITE_TYPE {ORGF_SINGE_SPRITE=0,ORGF_ANIMATED_SPRITE=1};
...
class ORGF_Gamepad
{
 ...
 char get_stick_x(const ORGF_GAMEPAD_STICKS stick);
 char get_stick_y(const ORGF_GAMEPAD_STICKS stick);
