...
void ORGF_Sprite::set_transparent(const bool enabled)
{
 transparent=enabled;
}

bool ORGF_Sprite::get_transparent()
{
 return transparent;
}
...
void ORGF_Sprite::set_position(const unsigned long int x,const unsigned long int y)
{
 current_x=x;
 current_y=y;
}
